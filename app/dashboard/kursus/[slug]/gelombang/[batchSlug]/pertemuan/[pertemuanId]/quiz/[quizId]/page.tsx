...
import QuizQuestion from "@/components/(dashboard)/kursus/gelombang/pertemuan/quiz/quiz-question";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export default DashboardSoalQuizPage;
