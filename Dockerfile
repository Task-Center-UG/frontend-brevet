...
ARG NEXT_PUBLIC_ASSET_URL_DEV
ARG NEXT_PUBLIC_ASSET_URL_PROD
...
ENV NEXT_PUBLIC_ASSET_URL_DEV=$NEXT_PUBLIC_ASSET_URL_DEV
ENV NEXT_PUBLIC_ASSET_URL_PROD=$NEXT_PUBLIC_ASSET_URL_PROD
