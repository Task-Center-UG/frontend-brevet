...
import {
  CreateQuizFormData,
  CreateQuizSchema,
} from "./_schemas/quiz-create-schema";
import { TQuiz } from "./_types/quiz-type";
import { fromIsoUtcToLocalDate } from "./_utils/utils";
import { TMeeting } from "../../kursus/gelombang/pertemuan/_types/meeting-type";
...
const QuizFormUpdate = ({ quizId, batchSlug, meetingId }: Props) => {
  ...
  const { mutate: updateQuiz, isPending } = usePatchData({
    ...
    backUrl: `/dashboard/kelas/${batchSlug}/quiz?${meetingId}`,
  });
