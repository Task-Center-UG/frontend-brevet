...
import QuizDatatable from "@/components/(dashboard)/kelas/quiz/quiz-datatable";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
const DashboardQuizDatatablePage = () => {
      ...
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        <div className="flex flex-row justify-end">
          <Button variant={"orange"} className="w-fit" asChild>
            <Link
              href={`/dashboard/kelas/${batchSlug}/quiz/tambah?${meetingId}`}
            >
              Tambah Quiz
            </Link>
          </Button>
        ...
        <Suspense>
          <QuizDatatable batchSlug={batchSlug} meetingId={meetingId} />
        </Suspense>
      </div>
    </section>
  );
...
export default DashboardQuizDatatablePage;
